...
public class MobileWebBuscarProdutoShoeStock extends FunctionsMobile {
    // ------------------------------ FIELDS ------------------------------
    private static final Logger log = LoggerFactory.getLogger(MobileWebBuscarProdutoShoeStock.class);

    // -------------------------- OTHER METHODS --------------------------
    @Test
    public void testbuscarProdutoMobileShoeStock() {
